...
if (isset($_POST['send'])) {
   ...
   $request = " INSERT INTO mvehicle_booking(name, email, phone, address, location, guests, arrivals, time_hour) VALUES('$name','$email','$phone','$address','$location','$guests','$arrivals','$time_hour') ";
