...
if (isset($_POST['add_product'])) {
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `vehicle`(name, price, image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if (isset($_GET['delete'])) {
   ...
   $delete_query = mysqli_query($conn, "DELETE FROM `vehicle` WHERE id = $delete_id ") or die('query failed');
   if ($delete_query) {
...
if (isset($_POST['update_product'])) {
   ...
   $update_query = mysqli_query($conn, "UPDATE `vehicle` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
...
<body>
   ...
   <div class="container">
      ...
      <section class="display-product-table">
         ...
         <table>
            ...
            <tbody>
               ...
               $select_products = mysqli_query($conn, "SELECT * FROM `vehicle`");
      ...
      <section class="edit-form-container">
         ...
         if (isset($_GET['edit'])) {
            $edit_id = $_GET['edit'];
            $edit_query = mysqli_query($conn, "SELECT * FROM `vehicle` WHERE id = $edit_id");
